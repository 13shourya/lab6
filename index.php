...
<!-- STEP 3: Build a NAV element for global Web site navigation -->
			<nav>
				<ul>
					...
					<li><a href="about.php" title="">about block</a></li>
				</ul>
			</nav>
...
<!-- STEP 8a: Create a NAV element in the FOOTER for the legal stuff -->
			<nav>
				<a href="about/terms-of-use.php" title="Read our terms of use">Terms of use</a> | <a href="about/terms-of-use.php#limitation-liability" title="Learn about limitations and liability-="></a>
